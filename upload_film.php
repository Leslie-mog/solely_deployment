...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($video_url_link)) {
        ...
        try {
            ...
            function handleUpload($fileKey, $dir, $maxSizeMB = 100)
            {
                ...
                // Give the file a random unique name (e.g., poster_654abc.jpg)
               // so users can't overwrite each other's files.
            ...
            try {
                $posterUrl = handleUpload('poster', $uploadDir);
                // Trailer is now a link, handled above
                $thumbnailUrl = handleUpload('thumbnail', $uploadDir);
